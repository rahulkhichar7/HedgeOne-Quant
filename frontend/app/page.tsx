...
import { useEffect, useId, useRef, useState } from "react";
import { Box, Button, CheckboxCard, ColorPicker, Dialog, Flex, useDisclosure } from "@chakra-ui/react"
...
function Item({ label, color, type, setColor}) {
  return (
    <CheckboxCard.Root>
      ...
      <CheckboxCard.Control>
        <CheckboxCard.Content>
          <CheckboxCard.Label>{label}
            <ColorPicker.Root onValueChange={setColor}>
...
function Dashboard() {
  ...
  const sidebarWidth = "300px" // open ? "200px" : "60px";
      ...
      >
        ...
        <Box mt="4" w="full">
          <Collapsible.Root w="full">
            <Collapsible.Trigger display="block" w="full"> Stocks/Indices
  ...
  <Dialog.Positioner>
    <Dialog.Content>
      ...
      <Dialog.Footer />
              ...
              <Item label="NIFTY" color="red" type="strategy" setColor={(color)=>{console.log(color)}}></Item>
            </Collapsible.Content>
          </Collapsible.Root>
        </Box>
        {/* )} */}
      ...
      <Box
        ...
        bg="gray.50"
      >
        <Chart data={[...state.stocks, ...state.indicators, ...state.strategies]} isOpen={open}></Chart>
      </Box>
    </Flex>
  );
}
